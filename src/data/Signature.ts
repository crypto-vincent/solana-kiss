...
/** Creates a Signature from a Base58-encoded string, validating that it is 64 bytes. */
...
/** Converts a Signature to its underlying 64-byte array. */
...
/** Converts a Signature to its Base58 string representation. */
