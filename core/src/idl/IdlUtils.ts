...
export const idlUtilsBytesJsonType = jsonTypeWithDecodeFallbacks(
  jsonTypeMapped(jsonTypeArray(jsonTypeNumber()), {
    map: (array: Array<number>) => new Uint8Array(array),
    unmap: (bytes: Uint8Array) => Array.from(bytes),
  }),
