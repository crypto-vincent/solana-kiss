...
hero:
  ...
  tagline: No bloat. No dependency. Full-featured Solana framework.
  actions:
    - theme: brand
      text: Get Started
...
features:
  ...
  - title: Fully typed
    details: Every primitive is a branded type. Pubkeys, signatures, block hashes – no accidental misuse.
  - title: Anchor IDL support
    details: Parse, load, encode, and decode any Anchor program's accounts and instructions automatically.
